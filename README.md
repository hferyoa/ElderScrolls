...
|Race|Name of Racial|Effect of Racial|Name of Alternate Racial Possibility|Effect of ARP|
|----|---|---|---|---|
|Altmer|Religious Zealotry|Pick a (D)Aedra to follow, gain spells and/or powers based on the entity you chose|||
|Argonian|Hist Connection||||
|Bosmer|Green Pact||||
|Breton|Forsworn||||
|Dunmer|Ancestral Summoning|New Questline to reconnect with your ancestors and be able to summon a high level ancestor|||
|Imperial|Royal Blood|Can summon and command Dwarven Automatons|Heirloom|Dwarven style Hammer with the Chim-el Adabal embedded into it. Banishes Daedra|
|Khajiit||Can cook a family Skooma recipe through Cooking using just Moon Sugar. This will restore and fortify health, stamina, and magicka, but will then drain them over time.|Aspect of the Cat|Transform into an cat form, increasing movespeed and allowing the player to jump to enemies.|
|Nord|Animal worship|Pick an animal to worship, gain spells and/or powers based on the animal you chose. You deal reduced damage when attacking that animal.|Berserking|Increase attack speed and movespeed for x seconds|
|Orsimer|Trinimac's Faithful||Berserking|Unlimited stamina, as well as taking less damage and dealing more damage|
|Redguard|Sword singing|Learn to summon your Shehai|||
...
|Enchanting|Enhance equipped weapons and armor with effects|Left: Attacks with equipped weapons or fists will danage an enemy's stamina. Right: Stamina recharges twice as fast|Left: Attacks with equipped weapons or fists will drain health. Right: Fortify health|Left: Attacks with equipped weapons or fists will deal additional frost damage. Right: Leave an icy wind behind you when you sprint, slowing enemies|Left: Attacks with equipped weapons or fists will deal additional shock damage. Right: Cloak yourself in an electric field, moving faster|Left: Attacks with equipped weapons or fists will deal additional fire damage. Right: Create a ward of fire, damaging the caster of any spell that hits you whilst you have this ward active|
